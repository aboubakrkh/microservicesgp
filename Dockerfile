...
ADD . /go/src/github.com/aboubakrkh/microservicesgp/tree/master/movies
# Setting up working directory
#WORKDIR /go/src/github.com/sarataha/cinema/movies
WORKDIR /go/src/github.com/aboubakrkh/microservicesgp/tree/master/movies

# Build the movies command inside the container.
#RUN go install github.com/sarataha/cinema/movies
RUN go install github.com/aboubakrkh/microservicesgp/tree/master/movies
